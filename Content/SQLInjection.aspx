<%@ Page Language="C#" validateRequest="false" AutoEventWireup="true" CodeBehind="SQLInjection.aspx.cs" Inherits="OWASP.WebGoat.NET.SQLInjection" MasterPageFile="~/Resources/Master-Pages/Site.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceholder" runat="server">
    ...
    <p>
        <asp:Button ID="btnAdd" runat="server" onclick="btnFind_Click" 
            Text="Find Employee" />
			<!--
        <asp:Button ID="Button1" runat="server" onclick="btnFindSecured_Click" 
        Text="Find Employee Sanitized" />
        <asp:Button ID="Button2" runat="server" onclick="btnFindNumeric_Click" 
        Text="Find Employee By Customers.customerNumber" />
		-->
    </p>
    <hr />
    <p>
